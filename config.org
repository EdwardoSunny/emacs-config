...
- [[#ide-set-up][IDE Set up]]
  - [[#codeium-copilot][Codeium Copilot]]
  - [[#magit][Magit]]
  - [[#lsp-mode][LSP Mode]]
...
** Codeium Copilot
As a senior L11 prompt engineer, copilots are very nice. Codeium is a free verison of github copilot.
#+begin_src emacs-lisp
;; (straight-use-package '(codeium :type git :host github :repo "Exafunction/codeium.el"))
#+end_src

On new setups, don't forget to run =M-x codeium-install= to setup the package.
